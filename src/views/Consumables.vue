...
export default {
  ...
  methods: {
    ...
    async getWearablesListings () {
      await this.$store.dispatch('fetchConsumablesListing', { blocksShown: this.blocksShown }).then(() => {
    ...
    async updateGraph () {
      ...
      await this.$store.dispatch('fetchConsumablesGraph', { blocksShown: this.blocksShown })
        .then(() => {
